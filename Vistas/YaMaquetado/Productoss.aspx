...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        ...
        <h1 class="h3 mb-3 fw-normal text-center">Nuestros productos</h1>
            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2" GroupItemCount="4" OnSelectedIndexChanged="ListView1_SelectedIndexChanged">
...
<td runat="server" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RevestimientoaytConnectionString %>" SelectCommand="SELECT [PU_Pro], [Stock], [Descripcion], [Categoria], [url] FROM [Productos] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')">
                <SelectParameters>
